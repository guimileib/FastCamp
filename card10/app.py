...
Código baseado no artigo: https://medium.com/pythoneers/building-a-multi-agent-system-using-crewai-a7305450253e

- Esse código implementa um sistema multi-agente usando CrewAI para recomendação personalizada de cursos
...
llm = ChatOpenAI(
    ...
    temperature=0.1,
    max_tokens=4000  # Reduzido para ficar dentro do limite do modelo
)

# Criação dos csv que contém o perfil do aluno 
...
# Junto a lista de cursos que são recomendados 
courses = '''
...
# agentes de campanha que produz o conteúdo para o aluno, segunda tripulação
...
# executa o processo para cada linha do conjunto de dados no perfil do aluno
df_output_list = [] 
...
for index, row in df_customers.iterrows():
  ...
  # pega a primeira tarefa e define os 3 principais cursos 
  ...
  #  pega a segunda tarefa gerando a campanha de recomendação e conteudos -> tripulação 2 
